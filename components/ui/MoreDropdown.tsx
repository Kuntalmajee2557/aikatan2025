...
import { MoreHorizontal, ChevronDown, Landmark, Phone, Info, FileText, Shield } from 'lucide-react';
...
const menuItems: MenuItem[] = [
  ...
  { id: '2', name: 'Contact Us', icon: <Phone size={16} className="text-green-400" />, url: '/contact' },
  { id: '3', name: 'About', icon: <Info size={16} className="text-blue-400" />, url: '/about' },
  { id: '4', name: 'T&C', icon: <FileText size={16} className="text-orange-400" />, url: '/terms' },
  { id: '5', name: 'Privacy & Policy', icon: <Shield size={16} className="text-purple-400" />, url: '/privacy' },
];
